<?php
	...
	function Change($rid,$rmoney)
	{
		...
		{      
			...
			mysql_query("insert into ssc_coin_log (`id`,`uid`,`type`,`playedId`,`coin`,`userCoin`,`fcoin`,`liqType`,`actionUID`,`actionTime`,`actionIP`,`info`,`extfield0`,`extfield1`,`extfield2`) values(null,'{$row['uid']}','0','0','{$rmoney}','{$rr['coin']}','0','1','0','".time()."','0','儲值','258','{$rid}','0')");
        }
