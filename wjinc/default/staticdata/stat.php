...
if($gameId==1|| $gameId==73 || $gameId==81|| $gameId==82 || $gameId==100 || $gameId==101 || $gameId==102 || $gameId==103 || $gameId==122 || $gameId==119 || $gameId==120 || $gameId==121){
	$sql=" and (name='大' or name='小' or name='單' or name='雙' or name='龍' or name='虎' or name like '總和%' or name like '尾%' or name like '合數%' )";	
}elseif($gameId==50 || $gameId==55|| $gameId==51 || $gameId==52|| $gameId==58 || $gameId==59|| $gameId==72){
	$sql=" and (name='大' or name='小' or name='單' or name='雙' or name='龍' or name='虎' or name like '冠亞%')";	
}elseif($gameId==60 || $gameId==61|| $gameId==107){
	$sql=" and (name='大' or name='小' or name='單' or name='雙' or name='龍' or name='虎' or name like '冠亞%')";	
}elseif($gameId==66|| $gameId==112){
	$sql=" and (name='大' or name='小' or name='單' or name='雙' or name='豹子' or name like '極%' or name like '%波')";	
}elseif($gameId==65|| $gameId==111 || $gameId==110){
	$sql=" and (name like '總%')";	
}elseif($gameId==21|| $gameId==117 || $gameId==118 || $gameId==106){
	$sql=" and (name='大' or name='小' or name='單' or name='雙' or name='龍' or name='虎' or name like '總和%')";	
}
