    ...
    <div class="graynavi">
        ...
        <div class="graynavibtn" rel="login.html">
            <a href="/"><div class="fl"><img src="/images/backarrow.jpg" width="23" height="35" alt="">
              ...
              <div class="fl marginleft20">首頁</div>
            </a>
          </div>
    </div>
</div>
<form action="/index.php/user/registered" method="post" onajax="registerBeforSubmit" enter="true" call="registerSubmit" target="ajax">
    ...
    <div class="rowfield clearfix">
        <div class="col1 fl margintop15">登入帳號：</div>
          <div class="col2 fl"><input type="text" id="username" name="username" class="text field_input">
            <div class="red cnsmall1" id='nameTips'>＊帳戶名由4-16個字元組成</div>
          </div>
    </div>
    <div class="rowfield clearfix">
        <div class="col1 fl margintop15">登入密碼：</div>
          <div class="col2 fl"><input type="password" id="password" name="password" class="text field_input">
            <div class="red cnsmall1">＊6-20個字母、數字或組合組成，區分大小寫</div>
          </div>
    </div>
    <div class="rowfield clearfix">
        <div class="col1 fl margintop15">確認密碼：</div>
          <div class="col2 fl"><input type="password" name="cpasswd" id="cpasswd" class="text field_input">
            <div class="red cnsmall1">＊請再次輸入密碼以確保輸入無誤</div>
          </div>
    </div>
    <div class="rowfield clearfix">
        <div class="col1 fl margintop15">QQ號碼：</div>
          <div class="col2 fl"><input type="text" name="qq" id="qq" maxlength="12" class="text field_input">
            <div class="red cnsmall1">請輸入QQ號碼</div>
          </div>
    </div>
	 <div class="rowfield clearfix">
        <div class="col1 fl margintop15">手機號碼：</div>
          <div class="col2 fl"><input type="text" name="phone" id="phone" maxlength="12" class="text field_input">
            <div class="red cnsmall1">請輸入手機號碼</div>
          </div>
    </div>
	<div class="rowfield clearfix">
        <div class="col1 fl margintop15">真實姓名：</div>
          <div class="col2 fl"><input type="text" name="name" id="name"  class="text field_input">
            <div class="red cnsmall1">請輸入真實姓名</div>
          </div>
    </div>
    <div class="rowfield clearfix">
      <div class="col1 fl margintop15">驗證碼：</div>
        <div class="col2 fl"><input type="text" name="vcode" id="vcode" class="field_input2 fl">
          <div class="captcha capcha fl"><img width="178" height="64" alt="驗證碼" align="absmiddle" src="/user/vcode/<?=$this->time?>" title="看不清楚，點我換圖" onclick="this.src='/user/vcode/'+(new Date()).getTime()"/></div>
        </div>
    </div>
    </div>
    <div class="rowfield clearfix">
      <div class="col1 fl margintop15"></div>
        <div class="col2 fl"><input type="submit" class="btnresetpass white cnbig1" id="btnRegister" value="建立帳號"></div>
      </div>
</form>
</body>
</html>
