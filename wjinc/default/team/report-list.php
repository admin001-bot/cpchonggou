...
<table width="100%" class='table_b'>
	...
	?>
		<tr>
            ...
            <td>
                ...
                <a target="ajax" dataType="html" call="searchData" class="qzbtn" href="<?="{$rel}/?parentId={$var['uid']}&type={$var['type']}&fromTime={$para['fromTime']}&toTime={$para['toTime']}"?>">下級</a>
				<?php }?>
	...
	<?php } ?>
		...
		<tr>
			<td><span class="spn9"><?php if(intval($para['userType'])==2){echo '直接下線';}else if(intval($para['userType'])==3){echo '所有下線';}else{echo '總結';}?></span></td>
