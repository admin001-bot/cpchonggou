...
<body class="login_bgsrcoll">
	...
	<!--<div class="login_logo"></div>-->
		<div class="login_logoform">
        	<ul>
                <li><label class="label_icon01">使用者名稱：</label><input name="username" maxlength="11" id="username" placeholder="請輸入您的用戶名" data-explain="使用者名稱須是6-12位數字+字母組合。" /></li>
                <li><label class="label_icon02">密碼：</label><input name="password" maxlength="16" id="password" placeholder="請設定密碼" data-explain="6~16位組成，建議使用字母和數字混合。" /></li>
                <li><label class="label_icon02">確認密碼：</label><input type="password" name="cpasswd" maxlength="16" id="cpasswd" placeholder="請再次輸入您設定的密碼" data-explain="請再次輸入密碼" /></li>
                <li><label class="label_icon02">QQ號碼：</label><input type="text" maxlength="11" name="qq" id="qq" placeholder="請輸入QQ號碼" data-explain="請輸入QQ號碼" /></li>
              <li class="nbr"><div class="yzm_div"><label class="label_icon03">驗證碼：</label><input name="vcode" id="vcode" type="text" value="" class="txt01" placeholder="驗證碼" /></div><div class="yzm"><img style="cursor:pointer;margin-bottom:0px;" alt="驗證碼" align="absmiddle" src="/user/vcode/<?=$this->time?>" title="看不清楚，點我換圖" onclick="this.src='/user/vcode/'+(new Date()).getTime()"/></div></li>
              <li class="nbr"><a href="javascript:void(0);" onclick="$(this).closest('form').submit()" class="login_btn">註 冊</a></li>
            </ul>
        </div>
