...
<div class="bottompage">
	...
	<?php if($this->page==1){ ?>
		<a class="disabled">首頁</a>&nbsp;
        <a class="disabled">上一頁</a>&nbsp;
	<?php }else{ ?>
	<a href="<?=set_page_url(1, $pageurl)?>">首頁</a>&nbsp;
    <a href="<?=set_page_url($prePage, $pageurl)?>">上一頁</a>&nbsp;
	<?php }
	...
	?>
	<a class="disabled">下一頁</a>
	<a class="disabled">尾頁</a>
	<?php }else{ ?>
	<a href="<?=set_page_url($nextPage, $pageurl)?>">下一頁</a>
	<a href="<?=set_page_url($pageCount, $pageurl)?>">尾頁</a>
	<?php } ?>
	<span class="disabled">第<?=$this->page?>頁/共<?=$pageCount?>頁</span>
</div>
