...
var messages = map[Language]map[string]string{
	...
	ZhCN: {
		...
		"bet.min_nums":         "注数不能小于 1，请重新投注",
		"bet.max_nums":         "注数不能大于 1000，请重新投注",
		"bet.min_money":        "投注总金额不能小于 1，请重新投注",
		...
		"login.token_invalid":       "token 无效或已过期",
		"login.login_required":      "请先登录",

		// 用户密码相关
		"user.oldPwdEmpty":       "原密码不能为空",
		"user.oldPwdMinLength":   "原密码至少 6 位",
		"user.newPwdEmpty":       "密码不能为空",
		"user.pwdMinLength":      "密码至少 6 位",
		"user.oldPwdIncorrect":   "原密码不正确",
		"user.changePwdFailed":   "修改密码失败",
		"user.enterOldPwd":       "请输入原密码",
		"user.enterNewPwd":       "请输入新密码",
		"user.oldCoinPwdEmpty":   "原提款密码不能为空",
		"user.oldCoinPwdMinLength": "原提款密码至少 6 位",
		"user.newCoinPwdEmpty":   "提款密码不能为空",
		"user.pwdSame":           "提款密码与登录密码不能一样",
		"user.changeCoinPwdFailed": "修改提款密码失败",
		"user.setFundPwdSuccess": "提款密码设定成功",
		"user.changeCoinPwdSuccess": "修改提款密码成功",
		"user.enterLoginPwd":     "请输入登录密码",
		"user.fillAllFields":     "请填写完整",
		...
		"register.usernameLength":  "用户名长度必须在 3-20 个字符之间",
