    ...
    $.ajax({ 
        ...
        success:function(json){ 
            ...
            $("#startbtn").rotate({ 
                ...
                callback: function(){ 
				 if (p=='一等獎'||p=='二等獎'||p=='三等獎'||p=='四等獎'||p=='五等獎'||p=='六等獎'){
					 confirm('恭喜！中得'+p+'！'); 
					 return false;
					 //lottery(); 
				 }
...
<div style="text-align:center;margin:60px 0; font:normal 14px/24px 'MicroSoft YaHei';">
  <div align="center" class="STYLE1">
    <p align="center" class="STYLE2">獎項設置</p>
    <p align="center" class="STYLE2">一等獎：888USD</p>
    <p align="center" class="STYLE2">二等獎：588USD</p>
    <p align="center" class="STYLE2">三等獎：188USD</p>
    <p align="center" class="STYLE2">四等獎：88USD</p>
    <p align="center" class="STYLE2">五等獎：18USD</p>
    <p align="center" class="STYLE2">六等獎：8USD</p>
    <p align="center" class="STYLE2">------------------------------------</p>
    <p align="center" class="STYLE2">提示：每人每天只能獲得一次抽獎機會！</p>
    <p align="center" class="STYLE2">&nbsp;</p>
    <p align="center" class="STYLE2">活動時間：長期有效</p>
    <p align="center" class="STYLE2">&nbsp;</p>
    <p align="center" class="STYLE2">參與對象：每天登入平台即可參加抽獎！</p>
  </div>
</div>
</body>
</html>
...
.en-markup-crop-options div div:first-of-type {
    margin-left: 0px !important;
           ...
           <div class="xl-le">
                ...
                <a class="cxjc" <a href="/index.php"><span>返回遊戲大廳</span></a>
