...
@session_start();
/*
 *通过改变$Cj1,$cj2,$cj3,$cj4,$cj5,$cj6,$cj7的值来改变不同獎次的中獎概率
 *当值为0时，表示中獎概率为0，用户永远无法抽到该獎次的獎品。
*/
...
$prize_arr = array( 
    '0' => array('id'=>1,'min'=>1,'max'=>29,'prize'=>'一等獎','v'=>$cj1, 'coin'=>888), 
    '5' => array('id'=>6,'min'=>62,'max'=>88,'prize'=>'二等獎','v'=>$cj2, 'coin'=>588), 
    '4' => array('id'=>5,'min'=>122,'max'=>148,'prize'=>'三等獎','v'=>$cj3, 'coin'=>88), 
    '3' => array('id'=>4,'min'=>182,'max'=>208,'prize'=>'四等獎','v'=>$cj4, 'coin'=>28), 
    '2' => array('id'=>3,'min'=>242,'max'=>268,'prize'=>'五等獎','v'=>$cj5, 'coin'=>18), 
    '1' => array('id'=>2,'min'=>302,'max'=>328,'prize'=>'六等獎','v'=>$cj6, 'coin'=>5), 
    '6' => array('id'=>7,'min'=>array(32,92,152,212,272,332), 
'max'=>array(58,118,178,238,298,358),'prize'=>'七等獎','v'=>$cj7, 'coin'=>0) //其它抽不中统归为七等獎
); 
...
$rid = getRand($arr); //根据概率获取獎项id 
 
$res = $prize_arr[$rid-1]; //中獎项 
$min = $res['min']; 
$max = $res['max']; 
if($res['id']==7){ //七等獎 
    $i = mt_rand(0,5); 
