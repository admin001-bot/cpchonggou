...
.controller('AppCtrl', function($scope, $rootScope, $location, $ionicHistory, $log, Tools, PATH, My, md5) {
	...
	Tools.lazyLoad([Tools.staticPath() + "data/configjs.js?_" + Math.random()], function() {
		...
		Tools.lazyLoad([Tools.staticPath() + "data/gamedatas.js" + APPVER]);
	});
...
// 	};
	...
	$scope.logout = function() {
		Tools.confirm('確認要退出該帳號？', function() {
			var token = My.getToken();
			if(!token) {
				$location.path(PATH.loginPath);
				return;
			...
			var ajax = function(opts) {
				...
				$http(req).success(function(data) {
					...
					if(status == 403) {
						...
						$ionicLoading.show({template: data.msg || '系統繁忙，請稍候重試', duration: 2000});
					}
...
.config(function($stateProvider, $urlRouterProvider, ROUTE_ACCESS) {
	...
	.state('login', {
    	...
    	templateUrl: 'views/login/login.html' + APPVER,
    ...
    .state('reg', {
    	url: '/reg',
    	data : {access : ROUTE_ACCESS.PUBLIC},
    	templateUrl: 'views/login/reg.html' + APPVER,
    	controller: 'RegCtrl'
    })
	...
	.state('home', {
		url: '/home',
    	data : {access : ROUTE_ACCESS.PUBLIC},
    	templateUrl: 'views/home/index.html' + APPVER,
		controller: 'HomeCtrl'
	})
    ...
    .state('ucenter.index', {
		...
		views: {
    		'ucenter-view': {
    			templateUrl: 'views/ucenter/index.html' + APPVER,
    ...
    .state('ucenter.myinfo', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: 'views/ucenter/myinfo.html' + APPVER,
    			controller: 'UCenterCtrl'
    		}
    	}
    })
    ...
    .state('ucenter.myfpwd', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: 'views/ucenter/mymdfpwd.html' + APPVER,
    			controller: 'UCenterCtrl'
    		}
    	}
    })
    ...
    .state('ucenter.notice', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: 'views/ucenter/notice.html' + APPVER,
    ...
    .state('ucenter.fundpwd', {
    	...
    	views: {
    		'ucenter-view': {
    			templateUrl: 'views/ucenter/fundpwd.html' + APPVER,
    			controller: 'UCenterCtrl'
    		}
    	}
    })
	.state('activitylist', {
		url: '/activitylist',
		data : {access : ROUTE_ACCESS.PUBLIC},
		templateUrl: 'views/activity/list.html' + APPVER,
	...
	.state('activity1', {
		...
		data : {access : ROUTE_ACCESS.PUBLIC},
        prefetchTemplate:false,
        templateUrl: 'views/activity/index1.html' + APPVER,
		controller: 'HomeCtrl'
	})
	.state('activity2', {
		url: '/activity2',
		data : {access : ROUTE_ACCESS.PUBLIC},
        prefetchTemplate:false,
        templateUrl: 'views/activity/index2.html' + APPVER,
		controller: 'HomeCtrl'
	})
	.state('activity3', {
		url: '/activity3',
		data : {access : ROUTE_ACCESS.PUBLIC},
        prefetchTemplate:false,
        templateUrl: 'views/activity/index3.html' + APPVER,
		controller: 'HomeCtrl'
	})
	.state('activity4', {
		url: '/activity4',
		data : {access : ROUTE_ACCESS.PUBLIC},
        prefetchTemplate:false,
        templateUrl: 'views/activity/index4.html' + APPVER,
		controller: 'HomeCtrl'
	})
	.state('activity5', {
		url: '/activity5',
		data : {access : ROUTE_ACCESS.PUBLIC},
        prefetchTemplate:false,
        templateUrl: 'views/activity/index5.html' + APPVER,
		controller: 'HomeCtrl'
	})
	.state('activity6', {
		url: '/activity6',
		data : {access : ROUTE_ACCESS.PUBLIC},
        prefetchTemplate:false,
        templateUrl: 'views/activity/index6.html' + APPVER,
		controller: 'HomeCtrl'
	})
	.state('activity', {
		url: '/activity:id',
...
.config(function($stateProvider, $urlRouterProvider, ToolsProvider, ROUTE_ACCESS) {
		...
		resolve : {
			deps : [ "$ocLazyLoad", function($ocLazyLoad) {
				return $ocLazyLoad.load([{
					name : "ionicz.lottery",
					files : [
						'views/lottery/js/config.js' + APPVER,
					    'views/lottery/js/controllers.js' + APPVER, 
					    'views/lottery/js/services.js' + APPVER, 
					    'views/lottery/js/filters.js' + APPVER, 
					    'views/lottery/js/directives.js' + APPVER
					]
				}]);
			} ],
			init: ['$q', 'Tools', function ($q, Tools) {
		        ...
		        Tools.lazyLoad([Tools.staticPath() + "data/gamedatas.js" + APPVER], function() {
					Backdrop.hide(500);
					deferred.resolve();
				});
	...
	.state('lottery.list', {
		...
		views: {
			'lottery-view': {
				templateUrl: 'views/lottery/list.html' + APPVER,
				controller: 'ListCtrl'
			}
		}
    })
    ...
    .state('lottery.index', {
		...
		views: {
			'lottery-view': {
				templateUrl: 'views/lottery/lottery.html' + APPVER,
    ...
    .state('lottery.history', {
		...
		views: {
			'lottery-view': {
				templateUrl: 'views/lottery/history.html' + APPVER,
    ...
    .state('lottery.notcount', {
		...
		views: {
			'lottery-view': {
				templateUrl: 'views/lottery/notcount.html' + APPVER,
    ...
    .state('lottery.detail', {
		...
		views: {
			'lottery-view': {
				templateUrl: 'views/lottery/notcount_detail.html' + APPVER,
    ...
    .state('lottery.settled', {
		...
		views: {
			'lottery-view': {
				templateUrl: 'views/lottery/settled.html' + APPVER,
    ...
    .state('lottery.changLong', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: 'views/lottery/changLong.html' + APPVER,
    ...
    .state('lottery.luZhu', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: 'views/lottery/luZhu.html' + APPVER,
    ...
    .state('lottery.week', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: 'views/lottery/week.html' + APPVER,
    ...
    .state('lottery.day', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: 'views/lottery/day.html' + APPVER,
    ...
    .state('lottery.day_detail', {
    	...
    	views: {
    		'lottery-view': {
    			templateUrl: 'views/lottery/day_detail.html' + APPVER,
...
.config(function($stateProvider, $urlRouterProvider, ToolsProvider, ROUTE_ACCESS) {
	...
	.state('bank', {
		...
		resolve : {
			deps : [ "$ocLazyLoad", function($ocLazyLoad) {
				return $ocLazyLoad.load([{
					name : "ionicz.bank",
					files : [ 
					    'views/bank/config.js' + APPVER,
					    'views/bank/bank.js' + APPVER,
					    ToolsProvider.staticPath() + 'data/paramcfg.js' + APPVER
					]
				}]);
			} ]
		}
	 ...
	 .state('bank.bank', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/bank.html' + APPVER,
	...
	.state('bank.deposit', {
		...
		views: {
			'bank-view': {
				templateUrl: 'views/bank/deposit.html' + APPVER,
    ...
    .state('bank.withdraw', {
		...
		views: {
			'bank-view': {
				templateUrl: 'views/bank/withdraw.html' + APPVER,
    ...
    .state('bank.trans', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/trans.html' + APPVER,
    ...
    .state('bank.bankpay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/bankpay.html' + APPVER,
    ...
    .state('bank.onlinepay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/onlinepay.html' + APPVER,
    ...
    .state('bank.cftpay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/cftpay.html' + APPVER,
    			controller:'OfflinePayController'
    		}
    	}
    })
    .state('bank.alipay', {
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/alipay.html' + APPVER,
    			controller:'OfflinePayController'
    		}
    	}
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/wechatpayonline.html' + APPVER,
    			controller:'OnlinePayController'
    		}
    	}
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/wechatpay.html' + APPVER,
    			controller:'OfflinePayController'
    		}
    	}
    	...
    	views: {
    		'bank-view': {
    			templateUrl: 'views/bank/alipayonline.html' + APPVER,
    			controller:'OnlinePayController'
    		}
    	}
    })
...
.service('My', function($rootScope, $location, $interval, $log, $filter, $cookies, Tools, PATH) {
    ...
    let num = parseFloat(self.info.money) || 0;
    return num.toFixed(2);  // 保留2位小数字符串返回
    };
