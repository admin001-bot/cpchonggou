...
$de = "RI/r53BgoNTpj9JDC4iGmxLaZAMle1kUS0OKtz7X+2PwHEchyfnFYsWvbqdQ8u6V";
...
if ( $sayhello ) {
    echo base64_decode(strtr("D/5EpiIwpY2w4rziLLsEMm2i1YyyZzA/CYxPMtmymg0Z4W2qxY2vAg0NTYuOjWEhAYu5CYf9js2ZMstqizIJAK4yxLudMvene/REpGb=", $de, $en));
} else {
